...
$(function () {
    ...
    var trackingData = [{
        data: sin,
        label: 'http://puffintheme.com/demo/oculux/html/assets/js/pages/charts/sin(x) = -0.00',
        color: '#9367B4'
    },
    {
        data: cos,
        label: 'http://puffintheme.com/demo/oculux/html/assets/js/pages/charts/cos(x) = -0.00',
        color: '#5CB65F'
    }
    ];
