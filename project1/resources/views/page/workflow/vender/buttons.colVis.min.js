(function(g){"function"===typeof define&&define.amd?define(["jquery","http://puffintheme.com/demo/oculux/assets/vendor/jquery-datatable/buttons/datatables.net","datatables.net-buttons"],function(d){return g(d,window,document)}):"object"===typeof exports?module.exports=function(d,e){d||(d=window);if(!e||!e.fn.dataTable)e=require("http://puffintheme.com/demo/oculux/assets/vendor/jquery-datatable/buttons/datatables.net")(d,e).$;e.fn.dataTable.Buttons||require("datatables.net-buttons")(d,e);return g(e,d,d.document)}:g(jQuery,window,document)})(function(g,d,e,h){d=g.fn.dataTable;g.extend(d.ext.buttons,{colvis:function(b,a){return{extend:"collection",
