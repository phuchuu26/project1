...
function drawDocSparklines() {
    ...
    $('.largeline').sparkline('html',
        { type: 'line', height: 'http://puffintheme.com/demo/oculux/html/assets/js/pages/charts/2.5em', width: '4em' });

    // Customized line chart
    $('#linecustom').sparkline('html',
        {
            height: 'http://puffintheme.com/demo/oculux/html/assets/js/pages/charts/1.5em', width: '8em', lineColor: '#FFA117', fillColor: '#2d3035',
